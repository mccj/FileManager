...
//            var _storageAccount = Microsoft.Azure.Storage.CloudStorageAccount.Parse(_options.ConnectionString);
...
//            {
//                return new BlobDirectory(path, System.DateTime.UtcNow);
//            }
...
//                            results.Add(new BlobDirectory(itemPath, System.DateTime.UtcNow));
//                            break;
