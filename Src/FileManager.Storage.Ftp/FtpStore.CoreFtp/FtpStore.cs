...
//{
//    public class CoreFtpStore : IFileStore
//    {
//        private readonly Limilabs.FTP.Client.Ftp _ftpClient;
//        public CoreFtpStore(Limilabs.FTP.Client.Ftp ftpClient/*, string fileSystemPath*/)
//        {
//            _ftpClient = ftpClient;
//        }
//        public CoreFtpStore(/*string fileSystemPath,*/ string host, int port, string user, string pass)
//        {
//            _ftpClient = new Limilabs.FTP.Client.Ftp();
...
//            {
//                var fileInfo = _ftpClient.MLST(path);
...
//        {
//            if (_ftpClient.FolderExists(path))
//            {
//                var directoryInfo = _ftpClient.MLST(path);
...
//            _ftpClient.CreateFolder(physicalDirectoryPath);
...
//            var result = _ftpClient.FolderExists(path);
//            return Task.FromResult(result);
...
//        {
//            return _ftpClient.FolderExists(newPath);
//        }
...
//            //{
//            //    Directory.CreateFolder(destDirName);
//            //}
