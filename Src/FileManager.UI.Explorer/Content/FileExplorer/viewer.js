...
version !== !1 && version < 9 && alert("Minimum supported version of Internet Explorer is 9.\nPlease upgrade your IE version or use another browser."); /*! jQuery v3.4.1 | (c) JS Foundation and other contributors | jquery.org/license */
! function (e, t) {
    "use strict";
            ...
            t.position = {
                ...
                return _ = s(v), v[0].preventDefault && (n.at = "left top"), p = _.width, f = _.height, g = _.offset, m = t.extend({}, g), t.each(["my", "at"], function () {
                    ...
                    var s, r, h = t(this)
                        ...
                        , D = u + _ + i(this, "marginBottom") + y.height
                        , C = t.extend({}, m)
        ...
        .on("mouseup", function () {
            ...
            , _mouseDown: function (e) {
                if (!n) {
                    ...
                    return s && !o && this._mouseCapture(e) ? (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function () {
                        ...
                        .on("mouseup." + this.widgetName, this._mouseUpDelegate), e.preventDefault(), n = !0, !0)) : !0
                }
            }
            ...
            , _mouseStop: function (e) {
                ...
                return this._helper && (i = this._proportionallyResizeElements, s = i.length && /textarea/i.test(i[0].nodeName), n = s && this._hasScroll(i[0], "left") ? 0 : u.sizeDiff.height, o = s ? 0 : u.sizeDiff.width, a = {
                    ...
                    top: h
                    , left: r
                })), u.helper.height(u.size.height), u.helper.width(u.size.width), this._helper && !l.animate && this._proportionallyResize()), t("body")
            ...
            start: function () {
                var e, i, s, n, o, a, r, h = t(this)
                    ...
                    , u = h.element
                    , c = l.containment
                    , d = c instanceof t ? c.get(0) : /parent/.test(c) ? u.parent()
                        .get(0) : c;
                ...
                d[0] !== document && /static/.test(d.css("position")) && (c = h), l.left < (a._helper ? h.left : 0) && (a.size.width = a.size.width + (a._helper ? a.position.left - h.left : a.position.left - c.left), u && (a.size.height = a.size.width / a.aspectRatio, p = !1), a.position.left = r.helper ? h.left : 0), l.top < (a._helper ? h.top : 0) && (a.size.height = a.size.height + (a._helper ? a.position.top - h.top : a.position.top), u && (a.size.width = a.size.height * a.aspectRatio, p = !1), a.position.top = a._helper ? h.top : 0), n = a.containerElement.get(0) === a.element.parent()
                    .get(0), o = /relative|absolute/.test(a.containerElement.css("position")), n && o ? (a.offset.left = a.parentData.left + a.position.left, a.offset.top = a.parentData.top + a.position.top) : (a.offset.left = a.element.offset()
                        .left, a.offset.top = a.element.offset()
                            .top), i = Math.abs(a.sizeDiff.width + (a._helper ? a.offset.left - c.left : a.offset.left - h.left)), s = Math.abs(a.sizeDiff.height + (a._helper ? a.offset.top - c.top : a.offset.top - h.top)), i + a.size.width >= a.parentData.width && (a.size.width = a.parentData.width - i, u && (a.size.height = a.size.width / a.aspectRatio, p = !1)), s + a.size.height >= a.parentData.height && (a.size.height = a.parentData.height - s, u && (a.size.width = a.size.height * a.aspectRatio, p = !1)), p || (a.position.left = a.prevPosition.left, a.position.top = a.prevPosition.top, a.size.width = a.prevSize.width, a.size.height = a.prevSize.height)
            }
            , stop: function () {
                var e = t(this)
                    .resizable("instance")
...
! function (n, t) {
    var i = t();
    "object" == typeof exports && "object" == typeof module ? (module.exports = i.WebViewer, module.exports.WebViewer = i.PortableEngine.WebViewer) : "function" == typeof define && define.amd ? define(t) : "object" == typeof exports ? (exports.PortableEngine = i.PortableEngine, exports.WebViewer = i.WebViewer) : (n.PortableEngine = i.PortableEngine, n.WebViewer = i.WebViewer)
}("undefined" != typeof self ? self : this, function () {
    function r(i, r) {
        return new Promise(function (u, f) {
            i.l = i.l || i.licenseKey;
            i.azureWorkaround = i.azureWorkaround || i.enableAzureWorkaround;
            i.annotationAdmin = i.annotationAdmin || i.isAdminUser;
            i.enableReadOnlyMode = i.enableReadOnlyMode || i.isReadOnly;
            i.showLocalFilePicker = i.showLocalFilePicker || i.enableFilePicker;
            var e = new n.WebViewer(i, r)
                , o = function () {
                    r.removeEventListener("ready", o);
                    try {
                        var n = r.querySelector("iframe")
                            .contentWindow
                            , s = n.Tools
                            , i = e.getInstance();
                        u(t({}, i, {
                            ...
                            , Actions: n.Actions
                            , PortableJS: n.PortableJS
                            , annotManager: i.docViewer.getAnnotationManager()
                            , docViewer: i.docViewer
                            , iframeWindow: n
                        }))
                    } catch (n) {
                        f("Viewer is on a different domain, the promise from WebViewer function is rejected and API functions will not work because of cross domain permissions. See https://gleamtech.com/kb_cross_origin for more information.")
                    }
                };
            r.addEventListener("ready", o)
        })
    }
    ...
    var n = n || {}
        , t, u, i, e;
    return "undefined" == typeof console && (window.console = {
        log: function () { }
        , warn: function () { }
        , error: function () { }
    }), t = function () {
        for (var t, n = 1; n < arguments.length; n++)
            for (t in arguments[n]) arguments[0][t] = arguments[n][t];
        return arguments[0]
    }, u = function (n, t) {
        var i;
        try {
        ...
        return i
    }, window.PortableJS && !n.skipPortableJSWebViewerWarning && console.warn("PortableJS.js and WebViewer.js have been included in the same context. See gleamtech.com for an explanation of why this could be an error in your application."), i = [], n.WebViewer = function (i, r) {
        var u, f;
        "legacy" === i.ui && (i.html5Path = "Reader.html", i.html5MobilePath = "MobileReader.html", void 0 === i.mobileRedirect && (i.mobileRedirect = !0));
        i.fullAPI && i.pdfServer && (i.forceClientSideInit = !0);
        this.options = t({}, n.WebViewer.Options, i);
        u = this.options.path.length - 1;
        0 < u && "/" !== this.options.path[u] && (this.options.path += "/");
        ...
        r || console.error("ViewerElement is not defined. This may be caused by calling the WebViewer constructor before the DOM is loaded, or an invalid selector. Please see https://www.gleamtech.com/documentation/web/guides/quick-start for an example.");
        this.element = r;
        this.element.style.overflow = "hidden";
        f = this;
        this.messageHandler = function (n) {
            if (n.source === f.iframe.contentWindow && ("requestl" === n.data && n.source.postMessage({
                type: "responsel"
                , value: i.l || i.licenseKey
            }, "*"), "requestConfig" === n.data)) {
                var t = i.config ? f._correctRelativePath(i.config) : "";
        ...
        version: "Wed Nov 27 2019 00:50:34 GMT+0300 (+03)"
        , create: function () {
            if (this.options.initialDoc) {
                var n = this._correctRelativePath(this.options.initialDoc);
                n = encodeURIComponent(n);
                this.options.initialDoc = n;
                this._create()
            } else this._create()
        }
        , _create: function () {
            this.rcId = (65536 * (1 + Math.random()) | 0)
                .toString(16)
                .substring(1);
            void 0 === this._trigger && (this._trigger = function (n, t) {
                var i = u(n, t);
                this.element.dispatchEvent(i)
            });
            var n = this.options.type.replace(" ", "")
                .split(",");
            n.length < 1 && (n[0] = "html5");
            this._createViewer(n)
        }
        , _validateOptions: function (i) {
            for (var r in i) r in t({}, e, n.WebViewer.Options) || console.warn(r + " is not a valid option name. See https://www.gleamtech.com/api/web/PortableEngine.WebViewer.html#Options__anchor for all available options.");
            !i.enableRedaction || i.fullAPI || i.pdfServer || console.warn("FullAPI or WebViewer Server is needed to apply redactions")
        }
        , _notSupportedMobile: function () {
            var n = document.createElement("div");
            n.id = "webviewer-browser-unsupported";
            n.textContent = "PDF document viewing is not supported by this browser.";
            this.element.appendChild(n)
        }
        , _createViewer: function (n) {
            var i, t = this
                , s, u, f;
            if (t.selectedType = null, "Never" !== t.options.mobileMode && isMobile[t.options.mobileMode.substring(2)
                .toLowerCase()]) {
                if (this.options.documentType && "xpz" !== this.options.documentType && !this._testWebAssembly()) return void this._notSupportedMobile();
                if (n = Array("html5Mobile"), t.selectedType = "html5Mobile", this.options.mobileRedirect) return i = this.options.html5MobilePath + this._getHTML5OptionsURL(), void (window.location = i)
            }
            for (var e = !1, o = !1, r = 0; r < n.length; r++) {
                if ("html5mobile" === n[r].toLowerCase()) {
                    if (this.options.documentType && "xpz" !== this.options.documentType && !this._testWebAssembly()) continue;
                    if (e = !0, t._testHTML5()) {
                        if (this.options.mobileRedirect) return t.selectedType = "html5Mobile", i = this.options.html5MobilePath + this._getHTML5OptionsURL(), void (window.location = i);
                ...
                if ("html5" === n[r].toLowerCase() && (e = !0, t._testHTML5())) {
                    if (s = t.isSameOrigin(decodeURIComponent(t.options.initialDoc)), this.options.xdomainProxyUrl || s || t._testCORS()) {
        ...
        , _viewerLoaded: function (n) {
            ...
            try {
                i = n.contentWindow;
                r = window;
                r.CoreControls = r.CoreControls || {};
                r.CoreControls.DisplayModes = i.CoreControls.DisplayModes;
                null === t.instance.docViewer.getDocument() ? i.$(n.contentDocument)
                    .on("documentLoaded", function (n) {
                        t._trigger(n.type)
                    }) : t._trigger("documentLoaded");
                i.$(n.contentDocument)
                    .on("displayModeChanged layoutModeChanged zoomChanged pageChanged fitModeChanged toolModeChanged printProgressChanged error partError", function () {
                        var n = arguments[0];
                        t._trigger(n.type, Array.prototype.slice.call(arguments, 1))
                    })
            } catch (n) {
                console.warn("Viewer is on a different domain, the promise from WebViewer function is rejected and API functions will not work because of cross domain permissions. See https://gleamtech.com/kb_cross_origin for more information.")
            }
        }
        , _isPDFExtension: function (n) {
            var t = !1;
            return n && [".pdf", ".png", ".jpg", "jpeg"].forEach(function (i) {
                n === i && (t = !0)
            }), t
        }
        , _isOfficeExtension: function (n) {
            var t = !1;
            return n && [".docx", ".doc", ".pptx"].forEach(function (i) {
                n === i && (t = !0)
            }), t
        }
        , _getHTML5OptionsURL: function () {
            var h, c, n, i, r, u, f, p, e, o, s;
            if ("html5" === this.selectedType ? this.options.html5Options && t(this.options, this.options.html5Options) : "html5Mobile" === this.selectedType && this.options.html5MobileOptions && t(this.options, this.options.html5MobileOptions), n = this.options, i = "", n.initialDoc && (i += "#d=" + n.initialDoc), void 0 === n.backendType && (n.backendType = n.pdfBackend), "legacy" === n.ui) {
                var l, a = !1
                    , v = !1
                    , y = n.initialDoc && (l = n.initialDoc.lastIndexOf(".")) ? n.initialDoc.slice(l)
                        .toLowerCase() : null;
                ("pdf" === n.documentType || "all" === n.documentType || void 0 === n.documentType && this._isPDFExtension(y)) && (v = !0);
                ("office" === n.documentType || "all" === n.documentType || void 0 === n.documentType && this._isOfficeExtension(y)) && (a = !0);
                n.documentType && (i += "&documentType=" + n.documentType);
                h = v;
                a && (i += n.backendType ? "&office=" + n.backendType : "&office=auto");
                h && (i += n.backendType ? "&pdf=" + n.backendType : "&pdf=auto")
            } else n.documentType && "xpz" === n.documentType && (r = n.documentType), n.preloadWorker && "xpz" === n.preloadWorker && (r = n.preloadWorker), n.extension && (r = n.extension), r && (i += "&extension=" + r), n.documentType && "xpz" !== n.documentType && (u = n.documentType), n.preloadWorker && "xpz" !== n.preloadWorker && (u = n.preloadWorker), u && (i += "&preloadWorker=" + u), n.backendType && (i += "&pdf=" + n.backendType + "&office=" + n.backendType);
            return (n.filename && (i += "&filename=" + n.filename), n.streaming && (i += "&streaming=" + n.streaming), n.externalPath) && (f = this._correctRelativePath(n.externalPath), f = encodeURIComponent(f), i += "&p=" + f), (n.encryption && (i += "&auto_load=false"), n.enableAnnotations && (i += "&a=1"), n.disabledElements && "legacy" !== n.ui) && (p = encodeURIComponent(n.disabledElements.join(",")), i += "&disabledElements=" + p), n.serverUrl && (e = this._correctRelativePath(n.serverUrl), e = encodeURIComponent(e), i += "&server_url=" + e), (void 0 !== n.language && (i += "&language=" + n.language), void 0 !== n.languageUrl && (i += "&languageUrl=" + encodeURIComponent(n.languageUrl)), n.serverUrlHeaders && (i += "&serverUrlHeaders=" + JSON.stringify(n.serverUrlHeaders)), n.documentId && (i += "&did=" + n.documentId), n.css) && (o = this._correctRelativePath(n.css), o = encodeURIComponent(o), i += "&css=" + o), "legacy" === n.ui && n.config && (s = this._correctRelativePath(n.config), s = encodeURIComponent(s), i += "&config=" + s), n.disableI18n && "legacy" !== n.ui && (i += "&disableI18n=1"), n.enableOfflineMode && (i += "&offline=1"), n.startOffline && (i += "&startOffline=1"), (n.enableReadOnlyMode || n.isReadOnly) && (i += "&readonly=1"), n.hideAnnotationPanel && (i += "&hideAnnotationPanel=1"), void 0 !== n.annotationUser && (i += "&user=" + n.annotationUser), void 0 === n.annotationAdmin && void 0 === n.isAdminUser || (i += "&admin=" + (n.annotationAdmin || n.isAdminUser ? 1 : 0)), void 0 !== n.custom && (i += "&custom=" + encodeURIComponent(n.custom)), void 0 === n.showLocalFilePicker && void 0 === n.enableFilePicker || (i += "&filepicker=" + (n.showLocalFilePicker || n.enableFilePicker ? 1 : 0)), "legacy" === n.ui && void 0 !== n.preloadPDFWorker && (i += "&preloadWorker=" + (n.preloadPDFWorker ? 1 : 0)), void 0 !== n.fullAPI && (i += "&portablejs=" + (n.fullAPI ? 1 : 0)), void 0 !== n.enableRedaction && (i += "&enableRedaction=" + (n.enableRedaction ? 1 : 0)), void 0 !== n.enableMeasurement && (i += "&enableMeasurement=" + (n.enableMeasurement ? 1 : 0)), void 0 !== n.showToolbarControl && (i += "&toolbar=" + (n.showToolbarControl ? "true" : "false")), void 0 !== n.showPageHistoryButtons && (i += "&pageHistory=" + (n.showPageHistoryButtons ? 1 : 0)), void 0 !== n.xdomainProxyUrl && (c = "string" == typeof n.xdomainProxyUrl ? {
                url: n.xdomainProxyUrl
            } : n.xdomainProxyUrl, i += "&xdomain_urls=" + encodeURIComponent(JSON.stringify(c))), (n.azureWorkaround || n.enableAzureWorkaround) && (i += "&azureWorkaround=1"), n.useDownloader || (i += "&useDownloader=0"), n.disableWebsockets && (i += "&disableWebsockets=1"), n.subzero && (i += "&subzero=1"), n.forceClientSideInit && (i += "&forceClientSideInit=1"), void 0 !== n.workerTransportPromise && (i += "&useSharedWorker=" + (n.workerTransportPromise ? "true" : "false")), void 0 !== n.pdfServer && n.pdfServer && (i += "&pdfServer=" + encodeURIComponent(n.pdfServer)), 0 < i.length && "&" === i[0] && (i = "#" + i.slice(1)), i
        }
        , addInstanceData: function (n) {
            i.push({
                iframe: n
        ...
        , _createHTML5: function () {
            var t = this
                , i = this.options.html5Path + this._getHTML5OptionsURL()
                , n = document.createElement("iframe");
            this.addInstanceData(n);
            n.id = this.rcId;
            n.src = i;
            n.title = "webviewer";
            n.frameBorder = 0;
            ...
            this.loadListener = function () {
                try {
                    t.instance = this.contentWindow.readerControl;
                    var n = this;
                    void 0 === t.instance ? this.contentWindow.$(this.contentDocument)
                        .on("viewerLoaded", function () {
                            t.instance = n.contentWindow.readerControl;
                            t._viewerLoaded(n)
                        }) : t._viewerLoaded(n)
                } catch (i) {
                    t._viewerLoaded(n)
        ...
        , _createHTML5Mobile: function () {
            var t = this
                , i = this.options.html5MobilePath + this._getHTML5OptionsURL()
                , n = document.createElement("iframe");
            this.addInstanceData(n);
            n.id = this.rcId;
            n.src = i;
        ...
        , getInstance: function () {
            return this.instance || console.error("The viewer instance is not defined yet. Try calling getInstance() in the ready event listener, or check https://www.gleamtech.com/documentation/web/guides/ui/apis for a detailed example."), this.instance
        }
        , getSideWindowVisibility: function () {
            return this.getInstance()
                .getShowSideWindow()
        }
        , setSideWindowVisibility: function (n) {
            this.getInstance()
                .setShowSideWindow(n)
        }
        ...
        , setShowSideWindow: function (n) {
            this.setSideWindowVisibility(n)
        }
        , getToolbarVisibility: function () {
            console.warn("Unsupported method getToolbarVisibility")
        }
        , setToolbarVisibility: function (n) {
            this.getInstance()
        ...
        , getLayoutMode: function () {
            var t = this.getInstance()
                .getLayoutMode()
                , i = this.iframe.contentWindow.CoreControls.DisplayModes;
            return t === i.Single ? n.WebViewer.LayoutMode.Single : t === i.Continuous ? n.WebViewer.LayoutMode.Continuous : t === i.Facing ? n.WebViewer.LayoutMode.Facing : t === i.FacingContinuous ? n.WebViewer.LayoutMode.FacingContinuous : t === i.Cover ? n.WebViewer.LayoutMode.FacingCoverContinuous : t === i.CoverFacing ? n.WebViewer.LayoutMode.FacingCover : void 0
        }
        , setLayoutMode: function (t) {
            var i = this.iframe.contentWindow.CoreControls.DisplayModes
                , r = i.Continuous;
            t === n.WebViewer.LayoutMode.Single ? r = i.Single : t === n.WebViewer.LayoutMode.Continuous ? r = i.Continuous : t === n.WebViewer.LayoutMode.Facing ? r = i.Facing : t === n.WebViewer.LayoutMode.FacingContinuous ? r = i.FacingContinuous : t === n.WebViewer.LayoutMode.FacingCover ? r = i.CoverFacing : t === n.WebViewer.LayoutMode.FacingCoverContinuous && (r = i.Cover);
            this.getInstance()
                .setLayoutMode(r)
        }
        ...
        , fitWidth: function () {
            var n = this.getInstance()
                .docViewer;
            n.setFitMode(n.FitMode.FitWidth)
        }
        , fitHeight: function () { }
        , fitPage: function () {
            var n = this.getInstance()
                .docViewer;
            n.setFitMode(n.FitMode.FitPage)
        }
        , getFitMode: function () {
        ...
        , setFitMode: function (t) {
            t === n.WebViewer.FitMode.FitWidth ? this.fitWidth() : t === n.WebViewer.FitMode.FitHeight ? this.fitHeight() : t === n.WebViewer.FitMode.FitPage ? this.fitPage() : t === n.WebViewer.FitMode.Zoom ? this.zoom() : console.warn("Unsupported fit mode: " + t)
        }
        , zoom: function () {
            var n = this.getInstance()
                .docViewer;
            n.setFitMode(n.FitMode.Zoom)
        }
        ...
        , loadDocument: function (n, i) {
            var u = {
                streaming: this.options.streaming
            }
                , r = t({}, u, i);
            void 0 !== r.documentId && (this.getInstance()
                .docId = r.documentId);
            this.getInstance()
                .loadDocument(this._correctRelativePath(n), r)
        }
        , searchText: function (n, t) {
            var u = 0
                , i = t
                , r;
            if ("string" == typeof i && (i = t.split(",")), void 0 !== i)
                for (r = 0; r < i.length; r++) "CaseSensitive" === i[r] ? u += 1 : "WholeWord" === i[r] ? u += 2 : "SearchUp" === i[r] ? u += 4 : "PageStop" === i[r] ? u += 8 : "ProvideQuads" === i[r] ? u += 16 : "AmbientString" === i[r] && (u += 32);
            void 0 === t ? this.getInstance()
                .searchText(n) : this.getInstance()
                    .searchText(n, u)
        }
        , setAnnotationUser: function (n) {
            this.getInstance()
                .setAnnotationUser(n)
        }
        , setAdminUser: function (n) {
            this.getInstance()
                .setAdminUser(n)
        }
        ...
        , downloadXpzDocument: function () {
            if ("xpz" === this.documentType) {
                var n = decodeURIComponent(this.options.initialDoc);
                window.open(n)
            } else console.warn("Unsupported method for this document type")
        }
        , startPrintJob: function (n) {
            "html5" === this.selectedType ? this.getInstance()
                .startPrintJob(n) : console.warn("Unsupported method startPrintJob")
        }
        , endPrintJob: function () {
            "html5" === this.selectedType ? this.getInstance()
                .endPrintJob() : console.warn("Unsupported method endPrintJob")
        }
        , getViewerType: function () {
            return this.selectedType
        }
        , _correctRelativePath: function (n) {
            if ("string" != typeof n) return n;
            var t = window.location.pathname.substr(0, window.location.pathname.lastIndexOf("/"));
            return /^(\/|%2F|[a-z0-9-]+:)/i.test(n) ? n : t + "/" + n
        }
        , _testHTML5: function () {
            try {
        ...
        , _supports: function (n) {
            if (n === this.selectedType) return !0;
        ...
        , scrollbarWidth: function () {
            var n = document.createElement("div")
                , t;
            return n.style.cssText = "width:100px;height:100px;overflow:scroll !important;position:absolute;top:-9999px", document.body.appendChild(n), t = n.offsetWidth - n.clientWidth, document.body.removeChild(n), t
        }
        , isSameOrigin: function (n) {
            var u = window.location
                , t = document.createElement("a")
                , i, r;
            return t.href = n, "" === t.host && (t.href = t.href), i = window.location.port, r = t.port, "http:" === t.protocol ? (r = r || "80", i = i || "80") : "https:" === t.protocol && (r = r || "443", i = i || "443"), t.hostname === u.hostname && t.protocol === u.protocol && r === i
        }
        , runInIframe: function (n) {
            var i = this.element.querySelector("iframe")
                .contentWindow
                , r = this
                , t = function () {
                    r.element.removeEventListener("ready", t);
                    n(i, r.getInstance(), i.$)
                };
            this.getInstance() ? setTimeout(t, 0) : this.element.addEventListener("ready", t)
        }
    }, n.WebViewer.Options = {
        initialDoc: void 0
        ...
        , html5MobileOptions: {}
        , html5MobilePath: "MobileReader.html"
        , html5Options: {}
        , html5Path: "Reader.html"
        , l: void 0
        , licenseKey: void 0
        , mobileRedirect: !1
        , path: ""
        ...
        , ProvideQuads: 16
        , AmbientString: 32
    }, n.WebViewer.User = function (n, t, i) {
        this.username = n;
        this.isAdmin = void 0 !== t && t;
        this.isReadOnly = void 0 !== i && i
    }, r.l = function (n) {
        var t = f(n);
        return t && t.l
    }, r.workerTransportPromise = function (n) {
        var t = f(n);
        return t && t.workerTransportPromise
    }, window.WebViewer = r, e = {
        licenseKey: void 0
        , enableAzureWorkaround: !1
        , isAdminUser: !1
        , isReadOnly: !1
...
function renderDocumentViewer(n) {
    var r, i, t;
    if (n.xclass) return !1;
    r = document.getElementById(n.id);
    n.displayMode === "Viewport" ? (jq321("html")
        .hasClass("dv-pageFull") || jq321("html")
            .addClass("dv-pageFull"), jq321("body")
                .hasClass("dv-pageFull") || jq321("body")
                    .addClass("dv-pageFull")) : n.resizable && jq321(r)
                        .resizable({
                            handles: n.resizeHandles
                            , helper: "dv-resizable-helper"
                        });
    n.type = "html5";
    n.documentType = "xpz";
    n.enableReadOnlyMode = !0;
    n.mobileRedirect = !1;
    n.ui = "legacy";
    n.cacheInfoKey && (n.documentUrl = n.initialDoc = n.handlerUrl + "/DownloadDocument?stateId=" + n.stateId + "&cacheInfoKey=" + n.cacheInfoKey, n.encryption = !0);
    i = new PortableEngine.WebViewer(n, r);
    t = document.getElementById(i.rcId)
        .contentWindow;
    window[n.id] = i;
    jq321(r)
        .on("partError", function (n, r, u) {
            u = u || "Downloading file part error occured and could not get the reason.";
            jq321.ajax({
                type: "POST"
                , contentType: "application/json"
                , processData: !1
                , dataType: "json"
                , url: i.options.handlerUrl + "/GetLastError"
                , data: JSON.stringify({
                    stateId: i.options.stateId
                })
                , success: function (n) {
                    if (!n.Result) {
                        t.readerControl.fireEvent("error", [u, u]);
                        return
                    }
                    var i = n.Result.Message;
                    i.indexOf("SessionExpired") !== -1 || i.indexOf("StateNotFound") !== -1 ? confirmRefreshPage(t) : t.readerControl.fireEvent("error", [n.Result, i])
                }
                , error: function () {
                    t.readerControl.fireEvent("error", [u, u])
                }
    ...
    jq321(r)
        .on("ready", function () {
            var n = i.options
                , u = window
                , f, e;
            if (u.CoreControls = u.CoreControls || {}, u.CoreControls.DisplayModes = t.CoreControls.DisplayModes, i.setFitMode(n.fitMode), i.setLayoutMode(n.layoutMode), n.clientEvents.loaded && (f = {
                eventName: "loaded"
            }, executeFunctionByName(n.clientEvents.loaded, i, f)), n.clientEvents.failed) t.$(t.document)
                .on("error", function (t, r, u) {
                    var f = {
                        eventName: "failed"
                        , message: u
                    };
                    executeFunctionByName(n.clientEvents.failed, i, f)
                });
            jq321(r)
                .on("documentLoaded error", function () {
                    t.$("#DocumentViewer, #viewerPage")
                        .removeClass("loading2")
                });
            t.readerControl.printOptions = n.printOptions;
            t.$(t.document)
                .on("documentLoaded", function () {
                    n.fitMode === "Zoom" && i.setZoomLevel(n.zoomLevel / 100);
                    t.readerControl.initFullTextSearch(n.searchOptions)
                });
            if (n.clientEvents.documentLoaded) t.$(t.document)
                .on("documentLoaded", function () {
                    executeFunctionByName(n.clientEvents.documentLoaded, i, {
                        eventName: "documentLoaded"
                    })
                });
            if (n.clientEvents.pageChanged) t.$(t.document)
                .on("pageChanged", function (t, r) {
                    var u = {
                        eventName: "pageChanged"
                        , pageNumber: r
                    };
                    executeFunctionByName(n.clientEvents.pageChanged, i, u)
                });
            if (n.clientEvents.pageRendered) t.$(t.document)
                .on("pageCompleted", function (t, r) {
                    var u = {
                        eventName: "pageRendered"
                        , pageNumber: r
                    };
                    executeFunctionByName(n.clientEvents.pageRendered, i, u)
                });
            if (n.clientEvents.rotationChanged) t.$(t.document)
                .on("rotationChanged", function (t, r, u) {
                    var f = {
                        eventName: "rotationChanged"
                        , pageNumber: u
                        , rotation: r * 90
                    };
                    executeFunctionByName(n.clientEvents.rotationChanged, i, f)
                });
            if (n.clientEvents.downloading) {
                t.$("#downloadButton")
                    .on("click", function () {
                        executeFunctionByName(n.clientEvents.downloading, i, {
                            eventName: "downloading"
                            , downloadType: "original"
                        })
                    });
                t.$("#downloadAsPdfButton")
                    .on("click", function () {
                        executeFunctionByName(n.clientEvents.downloading, i, {
                            eventName: "downloading"
                            , downloadType: "pdf"
            ...
            if (n.clientEvents.printing || n.clientEvents.printProgress) t.$(t.document)
                .on("printProgressChanged", function (t, r, u, f) {
                    var e;
                    if (r === 0 && n.clientEvents.printing) {
                        e = {
                            eventName: "printing"
                            , totalPages: u
                        };
                        executeFunctionByName(n.clientEvents.printing, i, e);
                        return
                    }
                    n.clientEvents.printProgress && (e = {
                        eventName: "printProgress"
                        , totalPages: u
                        , pageNumber: r
                        , originalPageNumber: f
                    }, executeFunctionByName(n.clientEvents.printProgress, i, e))
                });
            if (n.clientEvents.printed) t.$(t.document)
                .on("printComplete", function (t, r) {
                    var u = {
                        eventName: "printed"
                        , totalPages: r
                    };
                    executeFunctionByName(n.clientEvents.printed, i, u)
                });
            if (n.clientEvents.textSelected) t.$(t.document)
                .on("textSelected", function (t, r) {
                    var u = {
                        eventName: "textSelected"
                        , text: r
                    };
                    executeFunctionByName(n.clientEvents.textSelected, i, u)
                });
            if (n.clientEvents.textCopied) t.$(t.document)
                .on("textCopied", function (t, r) {
                    var u = {
                        eventName: "textCopied"
                        , text: r
                    };
                    executeFunctionByName(n.clientEvents.textCopied, i, u)
                });
            n.documentError ? t.readerControl.fireEvent("error", [n.documentError, n.documentError.message]) : n.cacheInfoKey && (n.firstTime && t.readerControl.showLoading(), e = n.encryptionEnabled !== !1 ? {
                decrypt: t.CoreControls.Encryption.decrypt
                , decryptOptions: {
                    p: getP(n.cacheInfoKey)
                    , type: "aes"
                    , error: function (n) {
                        t.readerControl.hideLoading();
                        t.readerControl.fireEvent("error", ["encryptionError", n])
                    }
                }
            } : {}, jq321.ajax({
                type: "POST"
                ...
                , processData: !1
                , dataType: "json"
                , url: n.handlerUrl + "/PrepareDocument"
                , data: JSON.stringify({
                    stateId: n.stateId
                    , cacheInfoKey: n.cacheInfoKey
                })
                , success: function (r) {
                    var u, f, o;
                    if (t.readerControl.hideLoading(), !r.Success) {
                        u = r.Result.Message;
                        u.indexOf("SessionExpired") !== -1 || u.indexOf("StateNotFound") !== -1 ? confirmRefreshPage(t) : t.readerControl.fireEvent("error", [r.Result, u]);
                        return
                    }
                    f = r.Result;
                    o = n.documentUrl + "&v=" + f;
                ...
                , error: function (n, i, r) {
                    ...
                    var u = "Status: " + i;
                    r && (u += "\nHTTP " + n.status + ": " + r);
                    t.readerControl.fireEvent("error", ["prepareDocumentError", u])
                }
            }))
        });
    return !0
...
function confirmRefreshPage(n) {
    n.$.confirm({
        title: "Refresh Page?"
        , content: "Session has expired, the page will be automatically refreshed in 10 seconds."
...
function executeFunctionByName(n) {
    var t, r;
    try {
        t = getFunctionFromString(n)
    } catch (i) {
        alert(i.message || i)
    }
    if (t) return r = Array.prototype.slice.call(arguments, 1), t.fn.apply(t.scope, r)
}

function getFunctionFromString(n, t) {
    for (var f, e, r = n.split("."), o = r.pop(), i = t || window, u = 0; u < r.length; u++)
        if (f = r[u], i = i[f], !i) throw "Could not find a function from string '" + n + "', namespace '" + f + "' is not found.";
    if (e = i[o], !e) throw "Could not find a function from string '" + n + "', function '" + o + "' is not found.";
    return {
        fn: e
        , scope: i
    }
}
var jq321 = jQuery.noConflict(!0)
    , loaderReady = loaderReady || null
    , loaderQueue = loaderQueue || []
    , FnUtils;
jq321(function () {
    for (var t, n = 0; n < loaderQueue.length; n++)(t = loaderQueue[n], t.dequeued) || (t.dequeued = renderDocumentViewer(t));
    loaderReady = loaderReady ? FnUtils.createSequence(loaderReady, renderDocumentViewer) : FnUtils.bind(renderDocumentViewer)
});
FnUtils = {};
FnUtils.createSequence = function (n, t, i) {
    return t ? function () {
        var r = n.apply(this, arguments);
        return t.apply(i || this, arguments), r
    } : n
};
FnUtils.bind = function (n, t) {
    return function () {
