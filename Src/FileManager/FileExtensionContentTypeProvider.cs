...
namespace FileManager
{
    public class FileExtensionContentTypeProvider
    {
        ...
        public FileExtensionContentTypeProvider(System.Collections.Generic.IDictionary<string, string> mapping)
        {
            if (mapping == null)
            {
                throw new System.ArgumentNullException("mapping");
            }
        ...
        /// </summary>
        public FileExtensionContentTypeProvider() : this(new System.Collections.Generic.Dictionary<string, string>(System.StringComparer.OrdinalIgnoreCase)
        {
            {
                ".323",
                "text/h323"
